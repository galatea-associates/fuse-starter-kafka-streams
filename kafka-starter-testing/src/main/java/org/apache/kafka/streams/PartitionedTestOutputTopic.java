...
/**
 * {@code TestOutputTopic} is used to read records from a topic in {@link PartitionedTopologyTestDriver}.
 * To use {@code TestOutputTopic} create a new instance via
 * {@link PartitionedTopologyTestDriver#createOutputTopic(String, Deserializer, Deserializer)}.
 ...
 */
public class PartitionedTestOutputTopic<K, V> {
  private final PartitionedTopologyTestDriver driver;
  private final String topic;
  private final Deserializer<K> keyDeserializer;
  private final Deserializer<V> valueDeserializer;

  PartitionedTestOutputTopic(final PartitionedTopologyTestDriver driver,
  ...
  public String toString() {
    return new StringJoiner(", ", PartitionedTestOutputTopic.class.getSimpleName() + "[", "]")
        .add("topic='" + topic + "'")
