...
/**
 * {@code TestInputTopic} is used to pipe records to topic in {@link PartitionedTopologyTestDriver}.
 * To use {@code TestInputTopic} create a new instance via
 * {@link PartitionedTopologyTestDriver#createInputTopic(String, Serializer, Serializer)}.
 ...
 * @see PartitionedTopologyTestDriver
 */

public class PartitionedTestInputTopic<K, V> {
  ...
  PartitionedTestInputTopic(final PartitionedTopologyTestDriver driver,
      final String topicName,
      final Serializer<K> keySerializer,
      final Serializer<V> valueSerializer,
      final Instant startTimestamp,
      final Duration autoAdvance) {
    Objects.requireNonNull(driver, "TopologyTestDriver2 cannot be null");
   ...
   * {@link PartitionedTopologyTestDriver} as long as no new input records are piped.
   * Furthermore, it does not advance the wall-clock time of {@link PartitionedTopologyTestDriver}.
   *
   ...
   * {@link #PartitionedTestInputTopic(PartitionedTopologyTestDriver, String, Serializer, Serializer, Instant, Duration) autoAdvance} setting.
   *
  ...
  public String toString() {
    return new StringJoiner(", ", PartitionedTestInputTopic.class.getSimpleName() + "[", "]")
        .add("topic='" + topic + "'")
